...
# combine seshat varibles with short variable names (Vars$ShortName)
...
# Polpulate the first column of out with NGA
...
# First populate 'out' with data tied to polities, not dates (any variable that does not have a date)
